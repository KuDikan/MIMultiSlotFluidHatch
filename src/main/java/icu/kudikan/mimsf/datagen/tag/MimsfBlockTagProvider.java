package icu.kudikan.mimsf.datagen.tag;
...
public class MimsfBlockTagProvider extends BlockTagsProvider {
    public MimsfBlockTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider,
    ...
    protected void addTags(HolderLookup.Provider provider) {
        for (BlockDefinition<?> definition : MIBlock.BLOCK_DEFINITIONS.values()) {
            if (definition.asBlock().getDescriptionId().contains("slots_fluid_")) {
